    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Task-Time exchange System</div>
          <div class="intro-heading text-uppercase">Find your assistor<br></div>
        </div>
      </div>
    </header>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" id="keywords" name="keywords" type="text" placeholder="please enter the time(eg:11am)" required data-validation-required-message="">
                       ...
                       echo   '<div class="row">
                        ...
                        echo '</div>
                          ...
                          <h4 class="text-center">Details</h4>';
                            ...
                            echo '<p><b>Age: </b>'.$value['plot_number'].'</p>';

                            if(isset($value['rent'])){
                              echo '<p><b>Salary: </b>$'.$value['rent'].' <small><i>per hour</i></small></p> ';
                            } 
...
*/
                            echo '<p><b>Available time: </b>'.$value['rooms'].'</p>';
                            echo '<p><b>Address: </b>'.$value['address'].'</p><p><b> speciality: </b>'.$value['landmark'].'</p>';
                        echo '</div>
                          <div class="col-3">
                          <h4>---------</h4>';
                          ...
                          echo '<p><b>Description: </b>'.$value['description'].'</p>';
                            if($value['vacant'] == 0){ 
                              echo '<div class="alert alert-danger" role="alert"><h3><b>Booked</b></h3></div>';
                            }else{
                              echo '<div class="alert alert-success" role="alert"><h3><b>Available</b></h3></div>';
                            } 
                          echo '</div>
                        </div>              
                       </div>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">&copy; Assistant finding System - <?php echo date("Y"); ?></span>
          </div>
          <div class="col-md-4">
