  		...
  		<form action="" method="POST">
			...
			<div class="row">
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="plot_number" placeholder="Age" name="plot_number" value="<?php echo $data['plot_number']?$data['plot_number']:''; ?>" required>
				  </div>
				 </div>
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="rooms" placeholder="etc 1pm-6pm" name="rooms" value="<?php echo $data['rooms']?$data['rooms']:''; ?>" required>
				  </div>
				 </div>
			</div>
			...
			<div class="row">
			 ...
			 <div class="form-group">
			    ...
			    <input type="rent" class="form-control" id="rent" placeholder="₹/hrs" name="rent" value="<?php echo $data['rent']?$data['rent']:''; ?>" required>
			  </div>
			  </div>
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <input type="landmark" class="form-control" id="landmark" placeholder="Speciality" name="landmark" value="<?php echo $data['landmark']?$data['landmark']:''; ?>" required>
			  </div>
			   </div>
			  <div class="col-md-4">
			  <div class="form-group">
			   	...
			   	<div class="col-4">
			 		 <div class="form-group">
					    ...
					    <select class="form-control" id="vacant" name="vacant">
					      <option value="1" <?php if($data['vacant'] == '1'){echo 'selected';}?>>Available</option>
					      <option value="0" <?php if($data['vacant'] == '0'){echo 'selected';}?>>Booked</option>
					    </select>
					  </div>
			 	</div>
			 	<div class="col-md-4">
