...
<?php include '../include/header.php';?>
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:#212529;" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="../index.php">Start</a>
...
<section class="wrapper" style="margin-left: 16%;margin-top: -23%;">
	<div class="container">
		<div class="row">
			...
			?>
			<h2>List of Personal Details</h2>
				<?php 
									 ...
									 echo 	'<div class="row">
										...
										echo '</div>
											...
											<h4 class="text-center">Details</h4>';
												...
												if(isset($value['sale'])){
													/*echo '<p><b>Salary/hour: </b>$'.$value['sale'].'</p>';*/
												}										
												...
												if(isset($value['own'])){
													...
													/*echo '<p><b>Seeker/Publisher: </b>'.$value['own'].'</p>';*/
													/*echo '<p><b>Purpose: </b>'.$value['purpose'].'</p>';*/
												}
												echo '<p><b>Salary/hour: </b>$'.$value['rent'].'</p>';
										...
										echo '</div>
											...
											echo '<p><b>Description: </b>'.$value['description'].'</p>';
												if($value['vacant'] == 0){ 
													echo '<div class="alert alert-danger" role="alert"><p><b>Booked</b></p></div>';
												}else{
