<?php
	...
	if(isset($_POST['register_individuals'])) {
			...
			try {
					$stmt = $connect->prepare('INSERT INTO room_rental_registrations (fullname, email, mobile, alternat_mobile, plot_number, country, state, city, address, landmark, rent, description, image, vacant, user_id) VALUES (:fullname, :email, :mobile, :alternat_mobile, :plot_number, :country, :state, :city, :address, :landmark, :rent, :description, :image, :vacant, :user_id)');
					$stmt->execute(array(
						':fullname' => $fullname,
						':email' => $email,
						':mobile' => $mobile,
...
<section class="wrapper" style="margin-left: 16%;margin-top: -11%;">
	...
	<ul class="nav nav-tabs" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Individual Registration</a>
	  </li>
	  <li class="nav-item">
